...
class Transition extends \Twig_Extension
{
    /**
    ...
    public function getFunctions()
    {
        ...
        return array(
            new \Twig_SimpleFunction('ts_graph_set', array($this, 'setActiveGraph'), $options),
            new \Twig_SimpleFunction('ts_graph_get', array($this, 'getActiveGraph'), $options),
            new \Twig_SimpleFunction('ts_graph_states', array($this, 'getGraphStates'), $options),
            new \Twig_SimpleFunction('ts_possibles', array($this, 'getPossibleTransitions'), $options),
            new \Twig_SimpleFunction('ts_transition_label', array($this, 'getTransitionLabel'), $options),
            new \Twig_SimpleFunction('ts_transition_color', array($this, 'getTransitionColor'), $options),
            new \Twig_SimpleFunction('ts_state_label', array($this, 'getStateLabel'), $options),
            new \Twig_SimpleFunction('ts_state_color', array($this, 'getStateColor'), $options),
        );
    }
